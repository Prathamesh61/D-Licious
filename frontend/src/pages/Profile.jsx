    ...
    <Box width={["100%"]}>
      <Box position={"relative"}>
        <Box height={"200px"} overflowY={"hidden"}>
          <Image
            src="https://www.licious.in/img/default/licious-b-1.jpg"
            filter={"blur(1.5px)"}
            width="100%"
            alt=" bannerImage"
          />
        ...
        <Box position={"absolute"} top="140" margin={"auto"} width={"100%"}>
          ...
          >
            <Image
              src="https://www.licious.in/img/rebranding/profile_icon_2.svg"
              alt="profile"
            />
            <VStack
              padding={"5px"}
              ...
              lineHeight={"16px"}
            >
              <Text textDecoration={"underline"} marginBottom={1.0}>
                {Profile?.user?.name}
              </Text>
              <Text fontSize={"14px"} lineHeight={"13px"}>
                {Profile?.user?.email}
              </Text>
              <Text fontSize={"13px"} lineHeight={"13px"}>
          ...
          <Box
            margin={"auto"}
            width={["70%", "50%", "30%"]}
            _hover={{ border: "1px solid #d11243" }}
              ...
              <AccordionItem borderRadius={"5px"}>
                <h3>
                  <AccordionButton>
                    <Image
                      width={"20px"}
                      src="https://www.licious.in/img/rebranding/rewards/milestone_logo.svg"
                    />
                    &nbsp;&nbsp;&nbsp;
          ...
          >
            ...
            >
              <Image
                ...
                alt="Licious-meta"
              />
              <Button bg={"#d11243"} color={"white"} size="sm">
                Join Now
              </Button>
            </HStack>
            <hr color={"black"} />
            <Text padding={"10px"} fontSize={"13px"} lineHeight={"13px"}>
              ...
              <AccordionItem borderRadius={"5px"}>
                ...
                <AccordionPanel pb={4}>
                  ...
                  >
                    <Center>
                      <Image
                        src="https://d2407na1z3fc0t.cloudfront.net/Banner/rebranding_v2_referAndEarn.svg"
                        alt="refer-a-friend"
                      />
                    </Center>
                    ...
                    <Text
                      ...
                      bg={"#dedede"}
                    >
                      LA7{Math.floor(Math.random(200) * 2)}XWNDR
                    </Text>
                    <Text>
                      Tell a friend they get Rs. 200 discount on min order value
                      of Rs.500. You get Rs. 200 Licious cash
                    </Text>
                  </VStack>
                </AccordionPanel>
              </AccordionItem>
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <Stack spacing="24px">
              ...
              <Box>
                <FormLabel fontSize={"13px"} htmlFor="Full Name">
                  Full name
                </FormLabel>
                <Input
                  name="name"
              ...
              <Box>
                <FormLabel fontSize={"13px"} htmlFor="Email">
                  Email
                </FormLabel>
                <Input
                  name="email"
              ...
              <Box>
                <FormLabel fontSize={"13px"} htmlFor="Phone">
                  Phone Number
                </FormLabel>
                <Input
                  name="mobile"
