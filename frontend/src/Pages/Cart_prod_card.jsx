    ...
    return (
        <VStack  padding={"10px"} borderBottom={"1px solid #a4a4a6"}>
            <HStack justifyContent={"space-between"} width={"100%"} gap={"3"}>
                <Text alignSelf={"start"} fontWeight={"700"} fontSize={"16px"}>Chicken Thigh Boneless</Text>
            ...
            <HStack width={"100%"} gap={"2"} justifyContent={"space-between"} >
                <HStack width={'50%'} justifyContent={"flex-start"} >
                    <Text fontSize={"14px"} padding={"5px"} border={"1px solid #a4a4a6"} color={"#a4a4a6"} borderRadius={"5px"}>450gms</Text>
                    <Text fontSize={"14px"} fontWeight={"600"} color={"#d11243"} >₹370</Text>
