  ...
  return (
    ...
    {/* Shop category */}
      ...
      <div className="rewarddiv">
        <img src="https://www.licious.in/img/rebranding/rewards/rewards_icon.svg" alt="revardslogo"/>
        <div>
          <p>
            <b>My Rewards</b>
            <br />
            <p style={{fontSize:"13px", marginTop:"5px"}}>Place an order and win your next reward!</p>
          </p>
          ...
          <div className='fourthDiv'>
            ...
            <div className='smallDiv'>
              ...
              <div className='slider_Card'>
                <div id="image1"><img src="https://dao54xqhg9jfa.cloudfront.net/OMS-ProductMerchantdising/faa6ff18-1108-6acf-4885-aa0fdb5e13ec/original/Chunky-Shawarma-Chicken-Spread_(7).jpg?format=webp" alt="image" /></div>
                <div id="heading1"><p>Chunky Shawarma Chicken Spread</p></div> 
                <div id="para1"><p>A creamy base with freshly roasted chicken chunks along...</p></div>
              ...
              <div className='slider_Card'>
                <div id="image1"><img src="https://dao54xqhg9jfa.cloudfront.net/OMS-ProductMerchantdising/b7cbafbe-bdf9-39cc-30c0-5a7c432309d8/original/Chunky-Herby-Tomato-Chicken-Spread_(1).jpg?format=webp" alt="image" /></div>
                <div id="heading1"><p>Chunky Herby Tomato Chicken Spread</p></div> 
                <div id="para1"><p>A pleasant contrast of Meaty chicken chunks flavored...</p></div>
                <div id="wt1"><p>Pieces: 1</p></div>
                <div id="blook1">
              ...
              <div className='slider_Card'>
                <div id="image1"><img src="https://dao54xqhg9jfa.cloudfront.net/OMS-ProductMerchantdising/0d28ad62-9409-c682-3c22-8e0ebc1697d5/original/Chunky-Continental-Chicken-Spread.jpg?format=webp" alt="image" /></div>
                <div id="heading1"><p>Chunky Continental Chicken Spread</p></div> 
                <div id="para1"><p>A Nakhrebaaz chef's creation: Real chicken & mega flav...</p></div>
                <div id="wt1"><p>Pieces: 1</p></div>
                <div id="blook1">
                  <p style={{ color: "#e1003e", fontWeight: "700" }}>MRP:  ₹219</p>
                  <ADDTOCARTBUTTON/>
      ...
      <div className='blogDiv'>
        ...
        <div className='divv'>
          ...
          <b><p className='para2'>See all</p></b>
        </div>

        <div className="checkoutdiv">
          <div className='checkoutdivinner'>
            <img src="https://www.licious.in/blog/wp-content/uploads/2022/11/shutterstock_559553158-1.jpg" alt=""/>
            <h5>All about Chicken Salami</h5>
          </div>

          <div className='checkoutdivinner'>
            <img src="https://www.licious.in/blog/wp-content/uploads/2022/11/shutterstock_1920454280.jpg" alt=""/>
            <h5>Sausages: Are Sausages Healthy? Health <br/> Benefits of Chicken Sausages for A Healthy You!</h5>
          </div>

          <div className='checkoutdivinner'>
            <img src="https://www.licious.in/blog/wp-content/uploads/2022/10/blog-image-02.jpg" alt=""/>
            <h5>Make Anda Paratha Rolls Special With Licious Chicken Lyoners!</h5>
          </div>
      ...
      <div className='fifthDiv'>
        ...
        <div className="newsdiv">
          <div className='newsdivinner'>
            <img src="https://d2407na1z3fc0t.cloudfront.net/inTheNews/35/inthenews_629f29838e296" alt=""/>
            <h6 style={{ color: "#4a4a4a" }}>Licious announces continuous liquidity of ESOPs</h6>
          </div>

          <div className='newsdivinner'>
            <img
              src="https://d2407na1z3fc0t.cloudfront.net/inTheNews/27/inthenews_61a248a937ab5" alt=""/>
            <h6 style={{ color: "#4a4a4a" }}>Why Licious wants to become the everything store</h6>
          </div>

          <div className='newsdivinner'>
            <img
              src="https://d2407na1z3fc0t.cloudfront.net/inTheNews/35/inthenews_61a250d471d48" alt=""/>
            <h6 style={{ color: "#4a4a4a" }}>India’s Licious becomes unicorn with $52 million</h6>
          </div>

          <div className='newsdivinner'>
            <img
              src=" https://d2407na1z3fc0t.cloudfront.net/inTheNews/35/inthenews_629f2b2c49d88" alt=""/>
            <h6 style={{ color: "#4a4a4a" }}>They slayed COVID, went on to build a unicorn: Meet</h6>
          </div>

          <div className='newsdivinner'>
            <img
              src="https://d2407na1z3fc0t.cloudfront.net/inTheNews/30/inthenews_61a24b7143569" alt=""/>
            <h6 style={{ color: "#4a4a4a" }}>Lucious Founder on building unicorn startup</h6>
          </div>
        </div>
      </div>
      {/* news */} 
