...
<Text color='#D11243' fontSize='25px' fontWeight='500'>MRP:</Text>
<Text color='#D11243' fontSize='45px' fontWeight='500'>₹269</Text>
</Flex>

<Box style={{marginLeft:"45%"}}>
<Button  
style={{backgroundColor:"#D11243",color:"white",height:"50px",}}>
...
<Image style={{marginTop:"2%"}} width='1300px' 
height='500px' src={liciousImg}/>
</Box>

<Box className="sourcing-box">
<Box className="head-box">
  <Box><Text fontSize='3xl' fontWeight='600' _hover={{color:"#D11243"}}>What You Get</Text></Box>
  <Box><Text  fontSize='3xl' fontWeight='600' _hover={{color:"#D11243"}}>Sourcing</Text></Box>
</Box>

<Divider borderColor="silver" />

<Box > 
<Text className="spaceing" style={{textAlign:"left"}} fontSize='2xl' fontWeight='500' >What's in your Box</Text>
<Box className="make-it-scroll"  style={{fontSize:"18px",color:"#5A5A5A"}}>
<Flex  className="spaceing"><Image width="25px" src={yes}/> 
...
<Flex className="spaceing"><Image width="25px" src={no}/> 
        ...
        {dataDigitalBestSeller.map((item) => (
          <div className="card">
            <div className="card-top">
              ...
              />
              <Text  className="Card-titleName">{item.title}</Text>
            </div>
            <Box fontSize='md' className="Card-middle">Cleaned and gutted, the Rohu is sliced perpendicular to the spine to get the Bengali Cut. Caught from  freshwaters, Rohu has a mild flavour, a smooth texture, and is a rich source of calcium, proteins, and omega-3 fatty acids. Compared to other fish, the Rohu is fattier, which enhances its flavour when fried or slow-cooked in curries. The Bengali Cut pieces are ideal for curries, pan-fried, or baked dishes. You can now buy the Rohu cuts online from Licious with just a few clicks.</Box>
